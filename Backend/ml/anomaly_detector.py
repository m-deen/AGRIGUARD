...
class AnomalyDetector:
    ...
    SPEED_THRESHOLD         = 15    # km/h — cattle rarely exceed this when grazing
    NIGHT_START             = 18    # 6 PM  (was 20 — now matches app logic)
    NIGHT_END               = 4     # 4 AM  (was 6  — now matches app logic)
    ...
    def train(self):
        ...
        for _ in range(300):
            ...
            if kind < 0.33:
                ...
                X_train.append([
                    random.uniform(18, 55),      # speed well above 15 km/h
                ...
                X_train.append([
                    random.uniform(1, 15),        # moderate speed
                    hour,
    ...
    def predict(self, speed, hour, distance_from_center, geofence_radius=None):
        ...
        Priority order (most objective first):
          ...
          3. Night Movement  — time based, 18:00–03:59
        ...
        # ── P3: Night Movement (time — 18:00–03:59) ──────────────────────────
